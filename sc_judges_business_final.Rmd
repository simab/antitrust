...
justice_scores %>%
  ...
  group_by(Party, era) %>%
  summarise(Era = era,
            `Business-friendliness mean` = round(mean(bf, na.rm = T), 3),
...
justice_scores %>%
  mutate(height = runif(n = 169, min = 0, max = 10)) %>%
...
justice_scores %>%
  ...
  select(justiceName, score_type, score, era, Party, justiceLastName) %>%
  pivot_wider(names_from = score_type, values_from = score) %>%
...
justice_scores %>%
  ...
  select(justiceName, score_type, score, Party, era, justiceLastName) %>%
  pivot_wider(names_from = score_type, values_from = score) %>%
...
justice_scores %>%
  ...
  select(justiceName, justiceLastName, score_type, score, Party, era) %>%
  pivot_wider(names_from = score_type, values_from = score) %>%
...
justice_votes %>%
  ...
  pivot_longer(!year) %>%
  mutate(name = recode(name, "psb_mean" = "Pro-small business",
                              "bf_mean" = "Business-friendliness",
                              "pe_mean" = "Pro-enforcement",
...
court_pe_score_top5 %>%
  ...
  geom_line() +
    ...
    labs(x = "Court Term", y = "Mean", title = "Moving average of top 5 monopoly-friendliness scores over SCT terms",
         color = "Type of score")
...
court_bf_score_top5 %>%
  ...
  geom_line() +
    scale_color_grey(start = 0.1, end = 0.5) + theme_minimal() +
    labs(x = "Court Term", y = "Mean", title = "Moving average of top 5 business friendliness and pro-enforcement scores over SCT terms",
         color = "Type of score")
...
court_justice_scores %>%
  ...
  ggplot() + geom_line(aes(x = court_term, y = score, color = type_case_score)) + 
    ...
    labs(x = "Court Term", y = "Moving average score by SCT personnel", 
         color = "Type of score",
...
justice_scores_tbl %>%
  ...
  rename(`Justice Name` = justiceLastName,
...
antitrust_westlaw_sc_cases %>%
  ...
  mutate(scoreType = case_when(scoreType == "govCase" ~ "Government litigant",
                            ...
                            T ~ "Other")) %>%
  group_by(year) %>%
  ggplot(aes(x = year, fill = scoreType)) + 
...
antitrust_westlaw_sc_cases %>%
  ...
  group_by(year) %>%
  ggplot(aes(x = year, fill = proAntitrustEnforcement)) + 
  geom_bar(position = "stack") + 
  theme_classic() + theme(legend.position = "bottom") +
  labs(title = "Win-loss ratio of Supreme Court antitrust cases", 
       x = "Court Term",
       y = "Count",
...
antitrust_westlaw_sc_cases %>%
  ...
  theme_classic() + theme(legend.position = "bottom", legend.title = element_blank()) +
  labs(title = "Win-loss ratio of antitrust cases by year", 
       x = "Court Term",
...
antitrust_westlaw_sc_cases %>%
  ...
  theme_classic() + theme(legend.position = "bottom", legend.title = element_blank()) +
  labs(title = "Win-loss ratio of antitrust cases by decade", 
       x = "Court Term",
       y = "Proportion of cases that expand enforcement") +
...
antitrust_westlaw_sc_cases %>%
  ...
  ggplot(aes(x = year, y = pro_enforce_perc)) + geom_point() +
  theme_classic() + theme(legend.position = "bottom", legend.title = element_blank()) +
  labs(title = "Win-loss ratio by year of antitrust cases involving business vs. business cases", 
       x = "Court Term",
...
antitrust_westlaw_sc_cases %>%
  ...
  ggplot(aes(x = decade, y = pro_enforce_perc)) + geom_point() +
  theme_classic() + theme(legend.position = "bottom", legend.title = element_blank()) +
  labs(title = "Win-loss ratio by decade of antitrust cases involving business vs. business cases", 
       x = "Court Term",
       y = "Proportion of business vs. business\n cases that expand enforcement") +
    scale_y_continuous(breaks= breaks_pretty())
...
antitrust_westlaw_sc_cases %>%
  ...
  theme_classic() + theme(legend.position = "bottom", legend.title = element_blank()) +
  labs(title = "Win-loss ratio by decade of antitrust cases\n of business vs. business cases", 
       x = "Court Term",
       y = "Proportion of business vs. business\n cases that expand enforcement") +
    scale_y_continuous(breaks= breaks_pretty())
```
...
antitrust_westlaw_sc_cases %>%
  ...
  ggplot(aes(x = year, y = pro_enforce_perc)) + geom_point() +
  theme_classic() + theme(legend.position = "bottom", legend.title = element_blank()) +
  labs(title = "Win-loss ratio by year of antitrust cases involving a government litigant", 
       x = "Court Term",
...
antitrust_westlaw_sc_cases %>%
  ...
  ggplot(aes(x = decade, y = pro_enforce_perc)) + geom_point() +
  theme_classic() + theme(legend.position = "bottom", legend.title = element_blank()) +
  labs(title = "Win-loss ratio by decade of antitrust cases involving a government litigant", 
       x = "Court Term",
       y = "Proportion of cases involving the government that expand enforcement") +
    scale_y_continuous(breaks= breaks_pretty())
...
antitrust_westlaw_sc_cases %>%
 ...
 # select(year, proAntitrustEnforcement) %>%
  ...
  theme_classic() + theme(legend.position = "bottom", legend.title = element_blank()) +
  labs(title = "Win-loss ratio of antitrust cases involving a government litigant", 
       x = "Court Term",
